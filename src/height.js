 ...
 * @returns {Number|Array<Number>|undefined} Either a length or an array of lengths depending on the options passed in, values are in px units. Return undefined if an element is not found.
 */
